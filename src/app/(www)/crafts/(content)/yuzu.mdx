...
<ClipRow>
  <Clip name="yuzu-squish" caption="pinned to the wall: squishes against it (slowed down)" />
  <Clip name="yuzu-squish-wrong" caption="pinned at the center: shrinks in place (slowed down)" />
</ClipRow>
