export const metadata = {
  ...
  media: [
    {
      type: "video",
      src: "https://res.cloudinary.com/dum8sg7sy/video/upload/q_auto:best/crafts/yuzu.webm",
    ...
    {
      type: "video",
      src: "https://res.cloudinary.com/dum8sg7sy/video/upload/q_auto:best/crafts/yuzu-mp4.mp4",
      alt: "Yuzu hiding on click and peeking back in",
    },
  ],
};
