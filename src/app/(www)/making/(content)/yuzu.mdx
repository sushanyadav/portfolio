  ...
  return (
    <figure className="m-0 min-w-0 flex-1">
      <BlurVideo
        ...
        className={
          wide
            ? "h-96 w-full border border-border [&>video]:size-full [&>video]:object-cover"
            : "border border-border max-sm:h-76 max-sm:w-full [&>video]:max-sm:size-full [&>video]:max-sm:object-cover"
        }
