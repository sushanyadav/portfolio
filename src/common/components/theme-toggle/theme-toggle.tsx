...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="flex size-8 cursor-pointer items-center justify-center rounded-none text-text-tertiary transition-colors duration-150 ease-out hover:text-text-primary"
