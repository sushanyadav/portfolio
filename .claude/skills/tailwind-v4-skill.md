...
Best practices and rules for Tailwind CSS v4.1+. This skill applies to ALL Tailwind usage, not just Figma extractions.

## Trigger

This skill applies automatically when writing any Tailwind CSS code.
